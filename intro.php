...
<h2>Badanie do pracy magisterskiej</h2><br>
...
<p class = "introTxt">
    ...
    Pierwsza dotyczy oceny 35 zdjęć. Pod każdym zdjęciem widnieje to samo pytanie "Czy podoba Ci się to zdjęcie".
    Zakres odpowiedzi to od "zdecydowanie nie" do "zdecydowanie tak".
    Spróbuj ocenić zdjęcia niezależnie od siebie. Jeśli będziesz mieć problem z odpowiedzią,
    ...
    <br>
    <br>
    Przejście do następnej strony formularza jest równoznaczne z wyrażeniem zgody na udział w badaniu.
    Rezygnacja z uczestniczenia w badaniu jest możliwa na każdym etapie wypełniania ankiety.
    <br>
    <br>
    Ankieta jest przeznaczona do wypełnienia na nośnikach o szerokości przynajmniej 1000px (czyli ekrany od 10 cali).
    <br>
    <br>
